...
namespace Final_DB
{
    public partial class trainerDietCreate : Form
    {
        string User_ID;
        public trainerDietCreate(string User_ID = "")
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = "Data Source=DESKTOP-31UM7RA\\SQLEXPRESS;Initial Catalog=GymDatabase;Integrated Security=True";
            string query = "Exec CreateDietPlanTrainer \'" + BreakFast + "\',\'" + Lunch + "\',\'" + Dinner + "\',\'" + User_ID + "\',\'" + DietType + "\'"; // Replace with your SQL query
        ...
        private void trainerDietCreate_Load(object sender, EventArgs e)
        {
