...
namespace Final_DB
{
    public partial class gymOwnerTrainer : Form
    {
        string User_ID;
        public gymOwnerTrainer(string User_ID = "")
        {
            InitializeComponent();
        ...
        {
            var new_thread = new Thread(() => Application.Run(new gymOwnerTrainerRemove(User_ID)));
            new_thread.Start();
            this.Close();
        }

        private void gymOwnerTrainer_Load(object sender, EventArgs e)
        {
