...
namespace Final_DB
{
    public partial class gymOwnerMembersRemove : Form
    {
        string User_ID;
        public gymOwnerMembersRemove(string User_ID = "")
        {
            InitializeComponent();
        ...
        private void gymOwnerMembersRemove_Load(object sender, EventArgs e)
        {
